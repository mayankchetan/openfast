...
subroutine ui_quad_src_11(CP, Sigma, xi, eta, RefPoint, R_g2p, UI)
   ...
   if (EqualRealNos_Target(xi2,xi1)) then ! Security - Hess 1962 - page 47 - bottom
      ...
      if( abs(DPp(3))<eps_quadsource ) then ! case where z is too small, jumps may occur 
         TAN12=Pi_Target*aint((signit(1.0_ReKi,(m12*e1-h1)) - signit(1.0_ReKi,(m12*e2-h2)))/2) ! Security-Hess1962-page47-top
      else
   ...
   if (EqualRealNos_Target(xi3,xi2)) then ! Security - Hess 1962 - page 47 - bottom
      ...
      if( abs(DPp(3))<eps_quadsource ) then ! case where z is too small, jumps may occur 
         TAN23=Pi_Target*aint((signit(1.0_ReKi,(m23*e2-h2)) - signit(1.0_ReKi,(m23*e3-h3)))/2) ! Security-Hess1962-page47-top
      else
   ...
   if (EqualRealNos_Target(xi4,xi3)) then ! Security - Hess 1962 - page 47 - bottom
      ...
      if( abs(DPp(3))<eps_quadsource ) then ! case where z is too small, jumps may occur 
         TAN34=Pi_Target*aint((signit(1.0_ReKi,(m34*e3-h3)) - signit(1.0_ReKi,(m34*e4-h4)))/2) ! Security-Hess1962-page47-top
      else
   ...
   if (EqualRealNos_Target(xi1,xi4)) then ! Security - Hess 1962 - page 47 - bottom
      ...
      if( abs(DPp(3))<eps_quadsource ) then ! case where z is too small, jumps may occur 
         TAN41=Pi_Target*aint((signit(1.0_ReKi,(m41*e4-h4)) - signit(1.0_ReKi,(m41*e1-h1)))/2) ! Security-Hess1962-page47-top
      else
