...
subroutine ui_quad_src_11(CP, Sigma, xi, eta, RefPoint, R_g2p, UI)
   ...
   if (abs(xi2-xi1) <= max(abs(xi2+xi1), 1.0_ReKi) * (100.0_ReKi * local_EPS / 2.0_ReKi)) then
      TAN12=0._ReKi
   else
   ...
   if (abs(xi3-xi2) <= max(abs(xi3+xi2), 1.0_ReKi) * (100.0_ReKi * local_EPS / 2.0_ReKi)) then
      TAN23=0._ReKi
   else
   ...
   if (abs(xi4-xi3) <= max(abs(xi4+xi3), 1.0_ReKi) * (100.0_ReKi * local_EPS / 2.0_ReKi)) then
      TAN34=0._ReKi
   else
   ...
   if (abs(xi1-xi4) <= max(abs(xi1+xi4), 1.0_ReKi) * (100.0_ReKi * local_EPS / 2.0_ReKi)) then
      TAN41=0._ReKi
   else
